...
const COLUMNS =
	'id, legal_name, filing_number, identification_number, entity_type, formation_state_id, management_type, tax_clasification, activity_code_id, us_source_income, activity_description';
