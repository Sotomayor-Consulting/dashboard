...
/**
 * Avatar de iniciales en círculo de color suave (estilo Linear/Notion).
 * El color se deriva del seed para que el mismo usuario siempre tenga
 * el mismo color, sin necesidad de guardarlo en DB.
 */

// Paletas suaves (light/dark) seleccionadas para AA contrast.
const PALETTE = [
	{
