document.addEventListener('click', async (e) => {
	...
	// ── Aprobación del cliente RETIRADA del flujo (se conserva comentada) ──
...
// ── Rechazo del cliente RETIRADO del flujo (se conserva comentado) ──
...
// 		alert(error instanceof Error ? error.message : 'Error al rechazar');
