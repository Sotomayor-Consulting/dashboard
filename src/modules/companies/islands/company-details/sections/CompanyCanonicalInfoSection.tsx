...
import type { CanonicalCompanyItem } from '../../../types';

interface Props {
	company: CanonicalCompanyItem | null;
	canEditDetails: boolean;
}

export default function CompanyCanonicalInfoSection({
	company,
	canEditDetails,
}: Props) {
	return (
		<section className="flex flex-col gap-4">
			<header className="flex flex-col gap-1">
				...
				<FieldDescription>
					Datos base de la empresa canónica relacionada con esta incorporación.
				</FieldDescription>
			</header>
