    ...
    try {
      ...
      if (error || !data?.session) {
        ...
        if (isPkceStateError && attempt < MAX_ATTEMPTS) {
          console.log("[callback] Detectado error PKCE/state. Esperando 300ms y reintentando...");
      ...
      console.log("[callback] Seteando cookies sb-access-token y sb-refresh-token...");
      if (access_token) {
      ...
      console.log("[callback] Cookies seteadas correctamente. Redirigiendo al home...");
